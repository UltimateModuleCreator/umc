...
namespace App\Umc\CoreBundle\Model\Attribute\Serialized;

use App\Umc\CoreBundle\Model\Attribute;
use App\Umc\CoreBundle\Model\Attribute\Serialized;
use App\Umc\CoreBundle\Model\Attribute\Serialized\Option\Factory as OptionFactory;
use App\Umc\CoreBundle\Model\Attribute\Serialized\Type\Factory as TypeFactory;
...
class Factory
{
     ...
     * @var string
     */
    private $className = Serialized::class;
